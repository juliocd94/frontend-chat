                      ...
                      <ul class="nav nav-pills side-menu-nav justify-content-center" role="tablist">
                          ...
                          <li class="nav-item dropdown profile-user-dropdown d-inline-block d-lg-none">
                              ...
                              <div class="dropdown-menu">
                                  ...
                                  <button class="dropdown-item" @click="logout()">Cerrar sesión <i class="ri-logout-circle-r-line float-end text-muted"></i></button>
                              </div>
                          </li>
                      </ul>
                  </div>
                  ...
                  <div class="flex-lg-column d-none d-lg-block">
                      <ul class="nav side-menu-nav justify-content-center">
                          ...
                          <li class="nav-item btn-group dropup profile-user-dropdown">
                              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  <img src="assets/images/users/avatar1.webp" alt="" class="profile-user rounded-circle">
                              </a>
                              <div class="dropdown-menu">
                                  <!-- <a class="dropdown-item" href="#">Perfil <i class="ri-profile-line float-end text-muted"></i></a>
                                  <a class="dropdown-item" href="#">Ajustes <i class="ri-settings-3-line float-end text-muted"></i></a> -->
                                  <div class="dropdown-divider"></div>
                                  <button class="dropdown-item" @click="logout()">Salir
