          ...
          <div>
            ...
            <div class="text-center p-4 border-bottom">
              ...
              <p class="text-muted text-truncate mb-1">
                <i
                  class="ri-record-circle-fill font-size-10 text-success me-1 ms-0 d-inline-block"
                ></i>
                Active
              </p>
            </div>
                  ...
                  <div class="accordion-header" id="about2">
                    ...
                    >
                      <h5 class="font-size-14 m-0">
                        <i
                          class="ri-user-2-line me-2 ms-0 ms-0 align-middle d-inline-block"
                        ></i>
                        About
                      </h5>
                    </button>
                ...
                <div class="card accordion-item border">
                  <div class="accordion-header" id="attachfile2">
                    ...
                    >
                      <h5 class="font-size-14 m-0">
                        <i
                          class="ri-attachment-line me-2 ms-0 ms-0 align-middle d-inline-block"
                        ></i>
                        Attached Files
                      </h5>
                    </button>
                          ...
                          <div class="collapse" id="groupmembercollapse">
                            <div class="card border">
                              <div class="card-header">
                                <h5 class="font-size-15 mb-0">Contactos</h5>
                              </div>
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1 overflow-hidden">
                        <h5 class="text-truncate font-size-14 mb-0">
                          #Reporting
                          <span
                            class="badge badge-soft-danger rounded-pill float-end"
                            >+23</span
                          >
                        </h5>
                      </div>
                ...
                >
                  <div class="modal-content">
                    ...
                    <div class="modal-body p-4">
                      <div>
                        <div class="mb-3">
                          <label for="addcontactemail-input" class="form-label"
                            >Email de usuario registrado</label
                          >
                          <input
...
<script>
import Chat from './widget/Chat.vue';
export default {
    props: {
        online: {
            type: Array,
    ...
    methods:{
        ...
        async EnviarMensaje() {
            await this.$api.$post("chats", this.contacto)
            .then((res)=>{
                this.modal = false;
            })
            .catch((e)=>{
    ...
    mounted(){
        ...
        this.contacto.perfil_id = user.user.perfil.id;
    }
}
</script>
